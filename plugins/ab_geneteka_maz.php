...
class ab_geneteka_maz_plugin extends research_base_plugin {
	static function getPluginName() {
		return 'Geneteka (Mazowieckie)';
	}
	...
	static function createLink($fullname, $givn, $first, $middle, $prefix, $surn, $surname) {
		...
		return $link = 'http://geneteka.genealodzy.pl/index.php?rid=A&from_date=&to_date=&search_lastname='.$surname.'&search_lastname2=&rpp2=20&rpp1=0&bdm=&w=07mz&op=gt&lang=pol';
	}
